...
class CommonController extends Controller
{
	...
	function get_fields(){
        ...
        <div class="form-control">
			...
			<script id="body'.$rd.'" name="body" type="text/plain" style="width:100%;height:400px;">'.stripslashes($data['body']).'</script>
		...
		foreach($fields_list as $k=>$v){
			...
			switch($v['fieldtype']){
				...
				$l .= '<div class="form-control">
		            <label for="'.$v['field'].'">'.$v['fieldname'].'：</label>
		            <div class="layui-input-block" style="width:100%;">
					<script id="body'.$rd.'" name="body" type="text/plain" style="width:100%;height:400px;">'.stripslashes($data[$v['field']]).'</script>
