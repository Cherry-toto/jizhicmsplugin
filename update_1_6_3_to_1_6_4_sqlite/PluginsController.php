...
class PluginsController extends Controller {
	...
	public  function install(){
		...
		if(!defined('DB_TYPE')){
			JsonReturn(['code'=>1,'msg'=>'当前升级插件不支持mysql版本升级！']);
		}
		
		$sqlx = "pragma table_info(".DB_PREFIX."classtype)";
		$list = M()->findSql($sqlx);
		$isgo = true;
		foreach($list as $v){
			if($v['name']=='ishome'){
		...
		$sqlx = "pragma table_info(".DB_PREFIX."links)";
		$list = M()->findSql($sqlx);
		$isgo = true;
		foreach($list as $v){
			if($v['name']=='member_id'){
		...
		$sqlx = "pragma table_info(".DB_PREFIX."member)";
		$list = M()->findSql($sqlx);
		$isgo_signature = true;
		$isgo_birthday = true;
		$isgo_follow = true;
		...
		$sqlx = "pragma table_info(".DB_PREFIX."orders)";
		$list = M()->findSql($sqlx);
		$isgo = true;
		foreach($list as $v){
			if($v['name']=='ptype'){
		...
		$sqlx = "pragma table_info(".DB_PREFIX."pictures)";
		$list = M()->findSql($sqlx);
		$isgo_molds = true;
		$isgo_path = true;
		$isgo_filetype = true;
		...
		$sql = "delete from ".DB_PREFIX."power;";
		M()->runSql($sql);
		$sql="INSERT INTO `".DB_PREFIX."power`  VALUES ('1','Common','公共权限','0','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('2','Home','前台网站','0','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('3','User','个人中心','0','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('4','Login','会员登录','0','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('5','Message','站内留言','0','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('6','Comment','会员评论','0','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('7','Screen','网站筛选','0','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('8','Order','会员下单','0','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('9','Mypay','网站支付','0','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('10','Jzpay','极致支付','0','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('11','Tags','TAG标签','0','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('12','Wechat','微信模块','0','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('13','Common/vercode','验证码生成','1','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('14','Common/checklogin','检查是否登录','1','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('15','Common/multiuploads','多附件上传','1','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('16','Common/uploads','单附件上传','1','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('17','Common/qrcode','二维码生成','1','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('18','Common/get_fields','获取扩展信息','1','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('19','Common/jizhi','链接错误提示','1','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('20','Common/error','报错提示','1','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('21','Home/index','网站首页','2','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('22','Home/jizhi','网站内容','2','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('23','Home/auto_url','自定义链接','2','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('24','Home/jizhi_details','详情内容','2','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('25','Home/search','网站搜索','2','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('26','Home/searchAll','网站多模块搜索','2','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('27','Home/start_cache','开启网站缓存','2','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('28','Home/end_cache','输出缓存','2','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('29','User/checklogin','检查是否登录','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('30','User/index','个人中心首页','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('31','User/userinfo','会员资料','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('32','User/orders','订单记录','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('33','User/orderdetails','订单详情','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('34','User/payment','订单支付','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('35','User/orderdel','删除订单','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('36','User/changeimg','上传头像','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('37','User/comment','评论列表','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('38','User/commentdel','删除评论','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('39','User/likesAction','点赞文章','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('40','User/likes','点赞列表','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('41','User/likesdel','取消点赞','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('42','User/collectAction','收藏文章','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('43','User/collect','收藏列表','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('44','User/collectdel','删除收藏','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('45','User/cart','购物车','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('46','User/addcart','添加购物车','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('47','User/delcart','删除购物车','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('48','User/posts','发布管理','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('49','User/release','会员发布','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('50','User/del','删除发布','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('51','User/uploads','会员上传附件','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('52','User/jizhi','404提示','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('53','User/follow','关注用户','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('54','User/nofollow','取消关注','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('55','User/fans','粉丝列表','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('56','User/notify','消息提醒','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('57','User/notifyto','查看消息','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('58','User/notifydel','删除消息','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('59','User/active','公共主页','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('60','User/setmsg','消息提醒设置','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('61','User/getclass','获取栏目列表','2','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('62','User/wallet','用户钱包','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('63','User/buy','会员充值','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('64','User/buylist','充值列表','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('65','User/buydetails','交易详情','3','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('66','Login/index','登录首页','4','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('67','Login/register','注册页面','4','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('68','Login/forget','忘记密码','4','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('69','Login/nologin','未登录页面','4','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('70','Login/loginout','退出登录','4','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('71','Message/index','发送留言','5','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('72','Comment/index','发表评论','6','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('73','Screen/index','筛选列表','7','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('74','Order/create','创建订单','8','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('75','Order/pay','订单支付','8','1');
INSERT INTO `".DB_PREFIX."power`  VALUES ('76','Tags/index','TAG标签列表','11','1');";
		M()->runSql($sql);
		...
		$path = APP_PATH;
		$tmp_path = APP_PATH.'A/exts/update_1_6_3_to_1_6_4_sqlite/file/update.zip';
